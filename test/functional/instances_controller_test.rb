...
class InstancesControllerTest < ActionController::TestCase
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post :create, instance: { application_id: @instance.application_id, description: @instance.description, inst_id: @instance.inst_id, name: @instance.name }
    end
  ...
  test "should update instance" do
    put :update, id: @instance, instance: { application_id: @instance.application_id, description: @instance.description, inst_id: @instance.inst_id, name: @instance.name }
    assert_redirected_to instance_path(assigns(:instance))
  end
